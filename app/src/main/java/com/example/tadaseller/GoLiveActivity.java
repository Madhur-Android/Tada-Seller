                ...
                binding.chargeBtn.setOnClickListener(v -> {
                    ...
                    if (state== false) {
                        ...
                        try {
                            ...
                            // Toast.makeText(GoLiveActivity.this, " current mare bijli bijli bijli bijli bijli bijli", Toast.LENGTH_SHORT).show();
                        ...
                        state = true;
                        binding.chargeBtn.setImageResource(R.drawable.ic_charge_on);
                        ...
                        state = false;
                        binding.chargeBtn.setImageResource(R.drawable.ic_charge_off);
